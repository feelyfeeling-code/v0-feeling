          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            <div className="flex-1 text-center lg:text-left">
              ...
              <p className="mt-6 text-lg md:text-xl text-muted-foreground max-w-2xl">
                Après 5 ans d’études, ton premier job mérite mieux qu’une
                candidature au hasard. Feeling t’aide à trouver une opportunité
            ...
            <div className="flex-1 flex justify-center">
              <div className="relative">
                <FeelyMascot
                  variant="purple"
                  size="xl"
                  speechBubble="Salut ! Je suis Feely"
                />
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Feeling, c&apos;est ton allié dans ta recherche d&apos;emploi.
                  Il t&apos;aide à trouver un job qui te ressemble vraiment. Pas
                  juste un job qui coche les cases, un job qui colle avec ta
                  personnalité et tes valeurs.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="relative">
              <div className="bg-secondary rounded-2xl p-6 h-full">
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">
                  Tu as répondu à quelques questions sur ta personnalité, tes
                  valeurs et tes ambitions. Pas ton CV, toi. Et c&apos;est là
                  que tout commence.
                </p>
              </div>
            </div>
            ...
            <div className="relative md:mt-12">
              <div className="bg-primary/30 rounded-2xl p-6 h-full">
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">
                  Colle le lien d&apos;une offre qui t&apos;intéresse. Feely
                  analyse si elle te ressemble vraiment.
                </p>
              </div>
            </div>
            ...
            <div className="relative md:mt-24">
              <div className="bg-accent/30 rounded-2xl p-6 h-full">
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">
                  Tu verras si cette offre te ressemble vraiment sur ta
                  personnalité, la culture de l&apos;entreprise et tes
                  compétences.
                </p>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="bg-background rounded-2xl p-8 shadow-sm border border-border text-center">
              ...
              <p className="text-muted-foreground text-sm">
                Une analyse basée sur ta personnalité unique, pas des critères
                génériques.
              </p>
            </div>
            ...
            <div className="bg-background rounded-2xl p-8 shadow-sm border border-border text-center">
              ...
              <p className="text-muted-foreground text-sm">
                Découvre si la culture d&apos;entreprise correspond à tes
                valeurs profondes.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-10">
              Rejoins Feeling et découvre si tes prochaines opportunités sont
              vraiment faites pour toi.
            </p>
            <Button
              size="lg"
              asChild
